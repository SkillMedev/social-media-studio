...
Threads live or die on the first post: 90%+ of potential readers see only the hook, so a mediocre hook wastes every good post behind it. The costly mistake is spreading one thin idea across fifteen posts or burying the payoff behind "a thread 🧵" with no substance. Earn each scroll.
...
- A (curiosity/story): "I deleted 80% of our landing page. Signups went up 34%. What we removed:"
- B (contrarian/claim): "Long landing pages are killing your signups. We cut ours to one screen and grew 34%. Proof:"

Same material, different bet: A sells the mystery of what was removed; B sells the argument. Pick A for story-driven audiences, B when the take itself is polarizing enough to drive replies.
...
- Restate the single takeaway in one post.
- One CTA only. Optional: a one-line summary post people can quote-tweet.

### Step 6: The scroll test

Read the thread top to bottom once in one sitting. At any post where you would stop scrolling, fix that post or cut it. Then check the numeric guardrails: 5-12 posts, hook under 200 characters, at least two concrete specifics across the body, exactly one CTA.

## Worked example thread (6 posts)

```
1/ I sent 200 cold emails with a 2% reply rate.
Rewrote one sentence. Reply rate hit 11%.
The sentence, and why it worked:

2/ The old opener: "Hi, I'm the founder of [company], we help teams do X."
...
4/ Why it works: it proves 30 seconds of research.
2% of cold email gets replies because 98% of it could be
sent to anyone. Specificity is the whole game.

5/ The formula: [thing you observed about them] + [what that
usually means] + one-sentence ask.
Under 60 words total. No deck attached.
...
Produce a numbered, post-by-post thread draft containing: two hook variants labeled A and B, 5-12 body posts each carrying one idea, a closing post with the takeaway and one CTA, and a one-line note on which hook to prefer and why.
...
- Hook under 200 characters, contains a specific payoff, and would stop your own scroll.
- 5-12 posts, one idea each, at least two concrete specifics in the body.
- Every post's last line creates pull toward the next.
- Exactly one CTA; the takeaway is stated, not implied.
- The thread survives the top-to-bottom scroll test with zero stop-points.

To adapt the finished thread into a LinkedIn post, newsletter section, or other formats, route to content-repurposing; for a native LinkedIn version written from scratch, use linkedin-post-writer.
